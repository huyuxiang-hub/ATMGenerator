...
Atm_tag=$(tag)
ATMROOT=/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7/offline/Generator/Atm
Atm_root=/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7/offline/Generator/Atm
ATMVERSION=v0
Atm_cmtpath=/junofs/users/huyuxiang/juno_centos7/offline
Atm_offset=Generator
Atm_project=offline
ROOT_tag=$(tag)
...
ProtonDecay_tag=$(tag)
PROTONDECAYROOT=/junofs/users/huyuxiang/juno_centos7/offline/Generator/ProtonDecay
ProtonDecay_root=/junofs/users/huyuxiang/juno_centos7/offline/Generator/ProtonDecay
PROTONDECAYVERSION=v0
ProtonDecay_cmtpath=/junofs/users/huyuxiang/juno_centos7/offline
ProtonDecay_offset=Generator
ProtonDecay_project=offline
tag=amd64_linux26
package=Atm
version=v0
PACKAGE_ROOT=$(ATMROOT)
srcdir=../src
bin=../$(Atm_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/afs/ihep.ac.cn/users/h/huyuxiang/junofs/juno_centos7/offline/Generator/Atm/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(Atm_linkopts)  $(ProtonDecay_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(ProtonDecay_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(CLHEP_root)/cmt/requirements 
use_includes= $(ppcmd)"$(ProtonDecay_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre0/ExternalLibs/ROOT/6.20.02/include" $(ppcmd)"$(CLHEP_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(Atm_stamps)  $(ProtonDecay_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(Atm_cflags)  $(ProtonDecay_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(Atm_pp_cflags)  $(ProtonDecay_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(Atm_cppflags)  $(ProtonDecay_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(Atm_pp_cppflags)  $(ProtonDecay_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(Atm_fflags)  $(ProtonDecay_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(Atm_pp_fflags)  $(ProtonDecay_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ProtonDecay_libraries)  $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
Atm_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Atm_use_linkopts=  $(Atm_linkopts)  $(ProtonDecay_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= Atm 
all_constituents= $(constituents)
constituentsclean= Atmclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
Atmprototype_dependencies= $(Atmcompile_dependencies)
